...
module "server-csv-module" {
  source  = "app.terraform.io/bso-cloud-03/server-csv-module/google"
  version = "1.0.0"
  csv_input_file_name = "./development/gcp_storage_input_test_disks_linux.csv"
}

module "vm-creation" {
  source  = "app.terraform.io/bso-cloud-03/vm-creation/google"
  version = "1.0.0"
  csv_input_file_name = "./development/gcp_storage_input_test_disks_linux.csv"
}